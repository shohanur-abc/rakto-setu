...
export class RequestsService {
    ...
    async create(user: AuthUser, dto: CreateBloodRequestDto) {
    ...
    async listOwn(user: AuthUser, query: PublicRequestQueryDto) {
    ...
    async listPublic(query: PublicRequestQueryDto) {
        const page = getPagination(query);
        const where = {
    ...
    async update(user: AuthUser, id: string, dto: UpdateBloodRequestDto) {
    ...
    async confirmCompletion(
        user: AuthUser,
        id: string,
        dto: ConfirmRecipientCompletionDto,
    ) {
    ...
    async listAdmin(query: AdminRequestQueryDto) {
        const page = getPagination(query);
        const where = {
            ...(query.status
